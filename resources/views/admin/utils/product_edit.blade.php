<script>
  $(function() {
    $('.has-many-productpes-forms').on('change', '.productpes.production_date', function () {
      ...
      beforeDate.parents('.has-many-productpes-form').find('.productpes.expiration_date').val(this_expiration_date)
    })
  })
</script>
